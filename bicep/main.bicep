...
var subnets = {
  cluster: {
    ...
    addressPrefix: vnetConfiguration.aksSubnet.prefix
    serviceEndpoints: [
      {
...
module vaultEndpoint './modules/private-endpoint/main.bicep' = if (enablePrivateLink) {
  ...
  params: {
    ...
    subnetResourceId: enableVnetInjection ? '${resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name)}/subnets/${vnetConfiguration.aksSubnet.name}' : '${network.outputs.resourceId}/subnets/${vnetConfiguration.aksSubnet.name}'
...
module manageSection 'modules/manage_section.bicep' = {
  name: 'manage-section'
  params: {
    manageLayerConfig: {
      sectionName: 'manage-section'
    ...
    vnetId: enableVnetInjection ? resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name) : network.outputs.resourceId
    vmSubnetId: enableVnetInjection ? '${resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name)}/subnets/${vnetConfiguration.aksSubnet.name}' : '${network.outputs.resourceId}/subnets/${vmSubnetName}'
  }
}
...
var serviceLayerConfig = {
  ...
  cluster: {
    ...
    networkPlugin: !enableSoftwareLoad || enablePodSubnet ? 'azure' : 'kubenet'
  }
  gitops: {
    name: 'flux-system'
...
var defaultPodSubnetId = enableVnetInjection ? '${resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name)}/subnets/${podSubnetName}' : '${network.outputs.resourceId}/subnets/${podSubnetName}'
...
module cluster './modules/aks_cluster.bicep' = {
  ...
  params: {
    ...
    aksSubnetId: enableVnetInjection ? '${resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name)}/subnets/${vnetConfiguration.aksSubnet.name}' : '${network.outputs.resourceId}/subnets/${vnetConfiguration.aksSubnet.name}'
    aksPodSubnetId: enablePodSubnet ? defaultPodSubnetId : null
    identityId: enableVnetInjection ? vnetConfiguration.identityId : stampIdentity.outputs.resourceId
...
module pool1 './modules/aks_agent_pool.bicep' = {
  ...
  params: {
    ...
    subnetId: enableVnetInjection ? '${resourceId(vnetConfiguration.group, 'Microsoft.Network/virtualNetworks', vnetConfiguration.name)}/subnets/${vnetConfiguration.aksSubnet.name}' : '${network.outputs.resourceId}/subnets/${vnetConfiguration.aksSubnet.name}'
    podSubnetId: enablePodSubnet ? defaultPodSubnetId : ''
